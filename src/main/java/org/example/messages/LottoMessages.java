...
public class LottoMessages {
    ...
    public static final String GIVE_NUMBER = "Please give a number";
    public static final String PLEASE_GIVE_NUMBER = "Please give %d a numbers";
    public static final String IS_NOT_IN_RANGE= "Wrong org.example.input.input. Please givea a number in range %d - %d inclusive";
    public static final String NOT_IN_RANGE_WITH_GIVEN_NUMBER= "Given number: %d must be in range %d-%d";
    public static final String GAME_RESULT= "You hit %d numbers! Winning numbers were %s, and yours were %s";
